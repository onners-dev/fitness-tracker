...
const WorkoutPlanEdit = () => {
  ...
  const equipmentOptions = ['Bodyweight', 'Dumbbells', 'Barbell', 'Kettlebell', 'Resistance Bands', 'Machine', 'Cable', 'No Equipment'];
  const fitnessGoals = [
  ...
  useEffect(() => {
    const fetchMuscles = async () => {
      try {
        ...
        setMuscles(['Biceps', 'Triceps', 'Chest', 'Back', 'Shoulders', 'Quadriceps', 'Hamstrings', 'Calves', 'Abs']);
      }
    };
    fetchMuscles();
  }, []);
    ...
    <div className="workout-plan-edit">
      <div className="plan-details-section">
        ...
        <select
          ...
          onChange={(e) => setPlanDetails(prev => ({ ...prev, fitnessGoal: e.target.value }))}
