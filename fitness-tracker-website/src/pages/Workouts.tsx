...
import { exerciseService, favoriteService } from '../services/api.js'
        ...
        <div className="exercise-modal-details">
          <div className="detail-section">
            ...
            <p>
              ...
              {exercise.equipment_options?.length
            ...
            <p>
              ...
              {exercise.muscle_groups && exercise.muscle_groups.length
          ...
          <button className="log-exercise-btn" onClick={handleLogExercise}>
            Log This Exercise
          </button>
        </div>
      </div>
...
const Workouts: React.FC = () => {
  ...
  useEffect(() => {
    const fetchFavorites = async () => {
      try {
        const data: Favorite[] = await favoriteService.getFavorites()
              ...
              filteredAndSortedExercises.map((exercise, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p>
                      <strong>Equipment:</strong> {exercise.equipment_options?.join(', ') || 'N/A'}
                    </p>
                    <p>
